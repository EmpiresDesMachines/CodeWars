...
const flattenTwoLevels = (array) => [...array].reduce((arr, e) => (typeof e === 'object' ? [...arr, [].concat(flat(e))] : [...arr, e]), []);

const flat = (arr) => [...arr].reduce((arr, e) => (typeof e === 'object' ? arr.concat(flat(e)) : [...arr, e]), []);