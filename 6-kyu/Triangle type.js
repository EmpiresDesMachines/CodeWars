...
function triangleType(a, b, c) {
  ...
  if (hypotenuse * 2 >= a + b + c) return 0; // Not triangle
  if ((hypotenuse ** 2 * 2) < a ** 2 + b ** 2 + c ** 2) return 1; // Acute
  if ((hypotenuse ** 2 * 2) === a ** 2 + b ** 2 + c ** 2) return 2; // Right
  if ((hypotenuse ** 2 * 2) > a ** 2 + b ** 2 + c ** 2) return 3; // Obtuse
}